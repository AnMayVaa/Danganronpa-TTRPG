...
const ALL_CLUES_DATA = [
  ...
  { id: 'EVD-02', aliases: ['C02', 'CORE-02', '2', 'E2'], name: 'มีดพกเปื้อนใยเชือกในกระเป๋าเสื้อ B', secretType: 'CORE', typeLabel: 'สำคัญแก่หลัก', loc: 'ร่างเหยื่อ B', desc: 'มีดพกพับเดินป่า ใบมีดมีคราบใยเชือกตากผ้าไนลอนติดอยู่ แสดงว่าเหยื่อใช้มีดตัดเชือกที่มัดมือตนเองจนขาดออกมาก่อนเสียชีวิต!' },
  ...
  { id: 'EVD-08', aliases: ['S04', 'SUPP-04', '8', 'E8'], name: 'เศษใยเชือกตากผ้าไนลอนไหม้เกรียมในตู้ควบคุมไฟ', secretType: 'SUPP', typeLabel: 'มีก็ดีช่วยเสริม', loc: 'ทางเดินโถงกลาง', desc: 'เศษเชือกตากผ้าไนลอนถูกผูกโยงระหว่างสวิตช์ไฟกับตัวตั้งเวลา ทำให้เกิดไฟดับชั่วขณะตอน 20:30 น.' },
