...
const ALL_CLUES_DATA = [
  ...
  { id: "EVD-25", aliases: ["SMELL-25", "25", "E25"], name: "กลิ่นคาวสนิมเหล็กในหม้อสตูว์ (ทอย WIS ผ่าน)", importance: "GOOD", secretType: "SUPP", typeLabel: "มีก็ดีช่วยเสริม", loc: "ห้องครัว / โต๊ะอาหารมื้อค่ำ", desc: "กลิ่นคาวสนิมเหล็กจางๆ ของเลือดสดมนุษย์และรสเค็มจัดของไวน์แดงในน้ำซุปสตูว์เนื้อ ผู้เล่นที่ประสาทสัมผัสไว (WIS ผ่าน) จะสังเกตเห็นว่ารสชาตินี้ผิดปกติ ไม่ใช่สตูว์เนื้อธรรมดา" },
  { id: "EVD-26", aliases: ["SOUND-26", "26", "E26"], name: "เสียงกระแทกตึงตังและเสียงโครมตอน 21:00 น.", importance: "GOOD", secretType: "SUPP", typeLabel: "มีก็ดีช่วยเสริม", loc: "ความทรงจำของผู้เล่น (ทอยนึกย้อนเหตุการณ์)", desc: "เสียงวัตถุขนาดหนักหมุนเหวี่ยงกระแทก 'ตึง! ตึง!' ดังลั่นมาจากห้องซักรีด ก่อนตามด้วยเสียงโครมใหญ่ด้านนอก จังหวะเสียงกระแทกมีความสม่ำเสมอเป็นรอบหมุนกลไก ไม่ใช่เสียงคนดิ้นรนปะทะกัน" },
  { id: "EVD-28", aliases: ["WINE-28", "28", "E28"], name: "คราบไวน์แดงและขวดไวน์เปิดทิ้งไว้ในครัว", importance: "GOOD", secretType: "SUPP", typeLabel: "มีก็ดีช่วยเสริม", loc: "ห้องครัว (เคาน์เตอร์ปรุงอาหาร)", desc: "ขวดไวน์แดงสำหรับทำอาหารเปิดฝาทิ้งไว้ ถูกเทจนเกือบหมดขวดอย่างเร่งรีบ มีคราบไวน์แดงหกกระเซ็นเป็นหยดๆ บนเคาน์เตอร์ข้างหม้อสตูว์ เพื่อกลบสีและกลิ่นคาวเลือดสด" },
  { id: "EVD-29", aliases: ["TRAIL-29", "29", "E29"], name: "รอยละอองน้ำหยดเป็นทางจากห้องซักรีดเข้าครัว", importance: "GOOD", secretType: "SUPP", typeLabel: "มีก็ดีช่วยเสริม", loc: "โถงทางเดินกลาง (พื้นแนวกำแพง)", desc: "ละอองน้ำประปาหยดเป็นจุดเล็กๆ บนพื้นกระเบื้องโถงทางเดิน นำทางจากหน้าห้องซักรีดมุ่งตรงสู่ประตูห้องครัว เกิดจากคนร้ายที่มือหรือชายเสื้อเปียกน้ำตอนเซ็ตถังรีบเดินกลับเข้าครัว" },
  { id: "EVD-30", aliases: ["DUTY-30", "30", "E30"], name: "ความทรงจำโต๊ะอาหาร: B หายตัวไป & เวรทำอาหาร", importance: "GOOD", secretType: "SUPP", typeLabel: "มีก็ดีช่วยเสริม", loc: "ห้องอาหาร (โต๊ะมื้อค่ำ 19:00 น.)", desc: "ตามตารางเวรของ Monokuma คืนนี้ถูกระบุว่า PC 5 เป็นเวรทำอาหารมื้อค่ำ ส่วน B หายตัวไปไม่ได้มาร่วมโต๊ะอาหาร ทุกคนคิดว่า B ขังตัวเองในห้องตามนิสัย ไม่คิดว่า B จะสลบอยู่ในห้องซักรีด" },
