...
const CLOSING_PAGES_DATA = [
  {
    ...
    panels: [
      ...
      },
      {
        ...
        sfxBadge: '*WHACK!*',
        title: 'ช่องว่างที่ 1: การลงมือจู่โจมเงาดำ',
        desc: '[TRAPPER] ดักซุ่มในห้องซักรีด ใช้ท่อนกระดูกหมูแช่แข็งฟาดท้ายทอยเงาดำคนร้ายจนสลบแน่นิ่งเวลา 17:30 น.',
        dialogue: '[TRAPPER]: "ผลั่ก! ...เงาดำคนร้ายล้มลงสลบแน่นิ่งไปแล้ว แผนการดักสังหารได้เริ่มต้นขึ้น!"',
  ...
  },
  {
    ...
    panels: [
      ...
      },
      {
        ...
        location: 'ห้องซักรีด ชั้น 1',
        sfxBadge: '*BIND... KNOT*',
        title: 'ช่องว่างที่ 1: การมัดร่างเงาดำและคล้องเชือก',
        desc: '[TRAPPER] ใช้เชือกตากผ้าไนลอนสีชมพูร้อยผูกมัดลำตัวเงาดำคนร้ายและคล้องเชือกพาดขึ้นสู่ราวท่อเพดาน',
        dialogue: '[TRAPPER]: "มัดตัวเงาดำไว้แน่นหนา คล้องบ่วงไว้หลวมๆ เพื่อรอน้ำหนักถ่วงดึงร่างขึ้นไป..."',
