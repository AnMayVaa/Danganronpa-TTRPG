...
const ALL_CLUES_DATA = [
  ...
  { id: "EVD-03", aliases: ["FREEZER-03", "ICE-03", "3", "E3"], name: "ช่องแช่แข็งในห้องครัว", importance: "GOOD", secretType: "SUPP", typeLabel: "มีก็ดีช่วยเสริม", loc: "ห้องครัว (ตู้เย็นช่องฟรีซ)", desc: "ช่องแช่แข็งของตู้เย็นในครัวมีเกล็ดน้ำแข็งละลายเป็นแอ่งน้ำบริเวณถาดชั้นวาง และพบถุงพลาสติกบรรจุเนื้อสัตว์แช่แข็งที่ถูกฉีกเปิดทิ้งไว้" },
  ...
  { id: "EVD-16", aliases: ["TEST-04", "PC4-16", "16", "E16"], name: "คำให้การของ PC 4", importance: "GOOD", secretType: "TESTIMONY", typeLabel: "คำให้การนักเรียน", loc: "ทางเดินกระจกใส (สอบถาม PC 4)", desc: "คำให้การ: \"ช่วง 17:30 ถึง 18:15 น. ฉันเดินอยู่ที่ทางเดินกระจก มองเห็นเงาวัตถุทรงกระบอกห้อยอยู่นอกหน้าต่างห้องซักรีด\"" },
  { id: "EVD-25", aliases: ["SMELL-25", "25", "E25"], name: "กลิ่นและรสชาติของน้ำซุปสตูว์", importance: "GOOD", secretType: "SUPP", typeLabel: "มีก็ดีช่วยเสริม", loc: "ห้องครัว / โต๊ะอาหารมื้อค่ำ", desc: "น้ำซุปสตูว์เนื้อในหม้อมีรสเปรี้ยวและเค็มจัดของไวน์แดงปรุงอาหาร พร้อมกลิ่นคาวจางๆ คล้ายสนิมเหล็กปะปนอยู่ในน้ำซุป" },
  ...
  { id: "EVD-21", aliases: ["GLASS-21", "21", "E21"], name: "เศษกระจกบริเวณเชิงบันได", importance: "OPTIONAL", secretType: "HERR", typeLabel: "หลอก (Red Herring)", loc: "เชิงบันไดทางขึ้นชั้น 2", desc: "เศษกระจกใสความหนา 5 มม. แตกกระจายอยู่บนขั้นบันไดทางขึ้นชั้น 2 บนขอบกระจกชิ้นหนึ่งมีคราบสีส้มอมแดงเกาะติดอยู่" },
  { id: "EVD-22", aliases: ["SNACK-22", "22", "E22"], name: "ซองขนมปังกรอบใต้เก้าอี้", importance: "OPTIONAL", secretType: "TRASH", typeLabel: "ขยะ (Trash)", loc: "ห้องอาหาร (ใต้เก้าอี้ทานข้าว)", desc: "ซองฟอยล์บรรจุขนมปังกรอบรสสาหร่ายถูกฉีกเปิดทิ้งไว้ใต้เก้าอี้ห้องอาหาร ภายในซองมีเศษขนมปังกรอบเหลืออยู่เล็กน้อย" },
  { id: "EVD-23", aliases: ["NOTE-23", "23", "E23"], name: "แผ่นกระดาษโน้ตบนพื้นโถงทางเดิน", importance: "OPTIONAL", secretType: "TRASH", typeLabel: "ขยะ (Trash)", loc: "โถงทางเดินกลาง (CORR-100)", desc: "กระดาษสมุดฉีกขนาดฝ่ามือ มีลายมือเขียนตารางเกมโอเอกซ์และข้อความสั้นๆ ตกอยู่บนพื้นกระเบื้องโถงทางเดิน" },
  { id: "EVD-24", aliases: ["CLIP-24", "24", "E24"], name: "คลิปหนีบกระดาษเหล็ก", importance: "OPTIONAL", secretType: "TRASH", typeLabel: "ขยะ (Trash)", loc: "หน้าบอร์ดประชาสัมพันธ์โถงทางเข้าหลัก", desc: "คลิปหนีบกระดาษทำจากลวดเหล็ก 3 ตัว สภาพมีคราบสนิมเกาะ ตกอยู่ในร่องรอยต่อของพื้นปูนหน้าบอร์ดประชาสัมพันธ์" },
];
